...
# Logistic regression:
fit1 <-  glm(response ~ AQP2.359 + ACOT12.134526 + GADL1.339896 + FXYD4.53828 + KCNJ1.3758 + SLC9A4.389015 + TDGF3.6998 + PTGER1.5731 + LOC284578.284578 + FLRT1.23769 + RS1.6247 + GPA33.10223 + RBP2.5948 + LY6G6F.259215	+ ACVRL1.94 + ANKRD1.27063 + GINS1.9837 + TMEM177.80775 + ABCA3.21 + CLEC3B.7123 + AQP7P3.441432 + ABCA10.10349 + LOC415056.415056 + LOC572558.572558 + ANGPTL7.10218 + LEP.3952	+ SYNM.23336	+ NAALAD2.10003	+ SLC19A3.80704 + ABCA9.10350, data = trainfold, family=binomial(link='logit'))
...
write_rds(x = list(team_name, team_people, team_error, team_predictions), 
          file = paste("tcga_prediction_2_", team_name, ".rds", sep=""))
